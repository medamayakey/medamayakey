...
const SheetHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex flex-col space-y-2 text-center sm:text-left mb-9", className)} {...props} />
);
SheetHeader.displayName = "SheetHeader";

const SheetFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn("flex sm:flex-row sm:justify-center sm:space-x-2", className)} {...props} />
);
...
>(({ className, ...props }, ref) => <SheetPrimitive.Description ref={ref} {...props} />);
